...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/x64/Debug/A1_ColEngine
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/x86/Debug/A1_ColEngine
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Debug
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/ARM64/Debug/A1_ColEngine
DEFINES += -DDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/x64/Release/A1_ColEngine
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/x86/Release/A1_ColEngine
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
TARGETDIR = bin/Release
TARGET = $(TARGETDIR)/A1_ColEngine.exe
OBJDIR = obj/ARM64/Release/A1_ColEngine
DEFINES += -DNDEBUG -DPLATFORM_DESKTOP -DGRAPHICS_API_OPENGL_33 -D_WIN32
...
$(OBJDIR)/AABBColider.o: src/Physics/AABBColider.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/CollisionManager.o: src/Physics/CollisionManager.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/DebugPhysicsDraw.o: src/Physics/DebugPhysicsDraw.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/physicsbody.o: src/Physics/physicsbody.cpp
	@echo "$(notdir $<)"
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
